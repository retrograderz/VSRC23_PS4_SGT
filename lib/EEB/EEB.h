...
public:
   ...
   void Stop(int servo_num);
       ...
       /*!
    *  @brief  Control angle of servo function by pulse
    *  @param  pulse_len in micros seconds, if want 1ms, type 1000
    *  @param  servo_num  number of servo  
    */
   void Pulse(unsigned long pulse_len, int servo_num);
